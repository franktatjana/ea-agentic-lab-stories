        ...
        <div className="space-y-8 text-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold md:text-5xl">
              Your best RFP response already exists.
            </h2>
            <p className="text-xl text-muted">
              It&apos;s scattered across 47 past submissions. Let agents
              reassemble it.
            </p>
          </div>
          ...
          <p className="text-sm text-muted pt-8 max-w-md mx-auto font-mono">
            ...
            {" "}&middot; Solutions Architect who answered too many RFPs from scratch.
          </p>
        </div>
      </ScrollReveal>
    </Section>
