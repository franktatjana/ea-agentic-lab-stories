      ...
      <div className="w-full max-w-3xl space-y-10 text-center">
        ...
        >
          <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl">
            Your team solved this problem 14 times.
          </h1>
          <p className="text-lg text-muted md:text-xl max-w-2xl mx-auto">
            Different people, different quarters, different accounts.
            Same problem. Same solution. Discovered from scratch every time.
          </p>
        </motion.div>
