        ...
        <div className="space-y-8 text-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold md:text-5xl">
              The sale ends. The promise doesn&apos;t.
            </h2>
            <p className="text-xl text-muted">
              A Customer Advocacy agent carries what was said from the pitch
              all the way to the renewal, so the CA inherits truth, not guesswork.
            </p>
          </div>
          ...
          <p className="text-sm text-muted pt-8 max-w-md mx-auto font-mono">
            ...
            {" "}&middot; Solutions Architect who has watched too many customers learn, on day 31, that the contract didn&apos;t match the pitch.
          </p>
        </div>
      </ScrollReveal>
    </Section>
